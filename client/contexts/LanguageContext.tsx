...
const translations = {
  en: {
    ...
    "analytics.overview": "Real website performance and visitor insights",
    ...
    "analytics.noDeviceData": "No device data available",
    "analytics.noErrorsGood": "No errors - site running smoothly!",
    ...
    "settings.levelFilter": "Level:",
    "settings.categoryFilter": "Category:",
    "settings.all": "All",
    ...
    "settings.exportLogs": "Export",
    "settings.clearLogs": "Clear",
    "settings.noLogsAvailable": "No logs available",
    ...
    "settings.successScreenSettings": "Success Screen Settings",
    ...
    "settings.deliveryAreas": "Delivery Areas",
    "settings.addDeliveryArea": "Add Delivery Area",
    "settings.removeDeliveryArea": "Remove",
  ...
  ar: {
    ...
    "revenue.monthlyTrend": "��تجا�� الإيرادات الشهرية",
    ...
    "message.orderUpdated": "تم تحديث ��لطلب بنجاح",
    ...
    "products.selectCategory": "ا��تر الفئة",
    ...
    "checkout.importError": "فشل استيراد الإعداد��ت. يرجى التحقق من تنسيق الملف.",
    ...
    "analytics.dataDescription":
      "تُظهر هذه اللوحة بيانات حقيقية من استخدام موقعك. البيانات محد��ة كل 30 ثانية.",
    "analytics.noDataAvailable":
    ...
    "analytics.homepage": "الصفحة الرئيسية",
    ...
    "dashboard.noOrdersYet": "لا توجد طلبات بعد. أنشئ أول طلب ��ك لرؤيته هنا!",
    "notFound.title": "404",
    ...
    "settings.levelFilter": "المستوى:",
    "settings.categoryFilter": "الفئة:",
    "settings.all": "الكل",
    "settings.error": "خطأ",
    ...
    "settings.orders": "الطلبات",
    "settings.products": "المنتجات",
    "settings.customers": "العملاء",
    "settings.refreshLogs": "تحديث",
    "settings.exportLogs": "تصدير",
    "settings.clearLogs": "مسح",
    "settings.noLogsAvailable": "لا توجد سجلات متاحة",
    ...
    // Contact Information
    "settings.contactInformation": "معلومات الات��ال",
    ...
    "settings.deliveryFeeHint": "التكلفة المحملة لخدمة التوص��ل",
    "settings.freeDeliveryMinimumHint":
